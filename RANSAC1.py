    ...
    for l in range(5):
     ...
     # put white positions in whites
        for i in range(width):
         ...
         #chose 30 numbers from 59 white pixels
        ...
        img2 = cv2.line(img, (int(20),int(20*m + c)), (int(30),int(30*m + c)), (255, 255, 0), 1)
       # img2 = cv2.line(img, (int(21), int(21 * m + c)), (int(22), int(22 * m + c)), (255, 255, 0), 1)
        whitesy.clear()
        whitesx.clear()
        whitesxx.clear()
        whitesyy.clear()
